...
class EconetSensor : public PollingComponent, public EconetClient {
 public:
  ...
  void set_temp_in_sensor(sensor::Sensor *sensor) { this->temp_in_sensor_ = sensor; }
  void set_temp_out_sensor(sensor::Sensor *sensor) { this->temp_out_sensor_ = sensor; }
  ...
  void set_water_used_sensor(sensor::Sensor *sensor) { this->water_used_sensor_ = sensor; }
  void set_btus_used_sensor(sensor::Sensor *sensor) { this->btus_used_sensor_ = sensor; }
  void set_ignition_cycles_sensor(sensor::Sensor *sensor) { this->ignition_cycles_sensor_ = sensor; }
  void set_instant_btus_sensor(sensor::Sensor *sensor) { this->instant_btus_sensor_ = sensor; }
  void set_hot_water_sensor(sensor::Sensor *sensor) { this->hot_water_sensor_ = sensor; }
  void set_ambient_temp_sensor(sensor::Sensor *sensor) { this->ambient_temp_sensor_ = sensor; }
  void set_lower_water_heater_temp_sensor(sensor::Sensor *sensor) { this->lower_water_heater_temp_sensor_ = sensor; }
  void set_upper_water_heater_temp_sensor(sensor::Sensor *sensor) { this->upper_water_heater_temp_sensor_ = sensor; }
  void set_power_watt_sensor(sensor::Sensor *sensor) { this->power_watt_sensor_ = sensor; }
  void set_evap_temp_sensor(sensor::Sensor *sensor) { this->evap_temp_sensor_ = sensor; }
  ...
  void set_cc_hvacmode_sensor(sensor::Sensor *sensor) { this->cc_hvacmode_sensor_ = sensor; }
  void set_cc_spt_stat_sensor(sensor::Sensor *sensor) { this->cc_spt_stat_sensor_ = sensor; }
  void set_cc_coolsetp_sensor(sensor::Sensor *sensor) { this->cc_coolsetp_sensor_ = sensor; }
  void set_cc_automode_sensor(sensor::Sensor *sensor) { this->cc_automode_sensor_ = sensor; }
  void set_cc_rel_hum_sensor(sensor::Sensor *sensor) { this->cc_rel_hum_sensor_ = sensor; }
  ...
  void set_hvac_odu_evaporator_temp_sensor(sensor::Sensor *sensor) { this->hvac_odu_evaporator_temp_sensor_ = sensor; }
  ...
  void set_hvac_odu_exv_super_heat_sensor(sensor::Sensor *sensor) { this->hvac_odu_exv_super_heat_sensor_ = sensor; }
